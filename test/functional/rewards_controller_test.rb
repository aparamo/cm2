...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { description: @reward.description, file_url: @reward.file_url, level_id: @reward.level_id, title: @reward.title, unlocked: @reward.unlocked }
    end
  ...
  test "should update reward" do
    put :update, id: @reward, reward: { description: @reward.description, file_url: @reward.file_url, level_id: @reward.level_id, title: @reward.title, unlocked: @reward.unlocked }
    assert_redirected_to reward_path(assigns(:reward))
  end
